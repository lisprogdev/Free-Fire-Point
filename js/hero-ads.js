// AdSense Visibility Control (Hero & About Sections)
(function() {
    'use strict';

    function checkAdSenseVisibility() {
        // Check hero ads
        const heroAdContainers = document.querySelectorAll('.hero-ads-container');
        checkContainerAds(heroAdContainers);
        
        // Check about ads
        const aboutAdContainers = document.querySelectorAll('.about-ads-container');
        checkContainerAds(aboutAdContainers);
    }

    function checkContainerAds(containers) {
